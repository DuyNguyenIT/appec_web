                ...
                <div class="row mb-2">
                    <div class="col-sm-6">
                        ...
                        <h1 class="m-0 text-dark">
                            Khảo sát CDR3<noscript></noscript>
                            <nav></nav>
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">Khảo sát Chuẩn đầu ra</li>
                        </ol>
                    </div>
                    <!-- /.col -->
                </div>
                                        ...
                                        <table id="example2"
                                            ...
                                            <thead>
                                                <tr class="table-primary" style="text-align: center">
                                                    ...
                                                    <th rowspan="2" style="vertical-align: middle;  width: 34%;">Tên CDR3
                                                    </th>
                                                            ...
                                                            @if ($i == 1)
                                                                ...
                                                                <tr id="co">
                                                                    ...
                                                                    <td class="td-center" style="width: 10%;"
                                                                        rowspan={{ $rs }}>{{ $x->maCDR3VB }}
                                                                    </td>
                                                                    <td style="vertical-align: middle; width: 35%;"
                                                                        rowspan={{ $rs }}> {{ $x->tenCDR3 }}
                                                                    </td>
        ...
        $(document).ready(function() {
            ...
            $('#submit').click(function(e) { //khi bam gui
                ...
                if (demFalse > 0) {
                    ...
                    $.ajax({
                        url: "{{ asset('/sinh-vien/hoc-phan/pks-cdr3/guiks-cdr3/' . $hocPhan->maHocPhan) }}",
                        method: 'POST',
