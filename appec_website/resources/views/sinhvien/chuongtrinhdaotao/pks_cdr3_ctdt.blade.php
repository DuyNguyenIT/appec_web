                ...
                <div class="row mb-2">
                    <div class="col-sm-6">
                        ...
                        <h1 class="m-0 text-dark">
                            Khảo sát CDR3 chương trình đào tạo<noscript></noscript>
                            <nav></nav>
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">Khảo sát CDR3 chương trình đào tạo</li>
                        </ol>
                    </div>
                    <!-- /.col -->
                </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <form name="khaosat" id="khaosat">
                                        ...
                                        <table id="example2"
                                            ...
                                            <thead>
                                                <tr class="table-primary" style="text-align: center">
                                                    ...
                                                    <th rowspan="2" style="vertical-align: middle;  width: 10%;">Mã CDR3
                                                    </th>
                                                    <th rowspan="2" style="vertical-align: middle;  width: 34%;">Tên chuẩn đầu ra
                                                    </th>
                                                                ...
                                                                <tr id="co">
                                                                    ...
                                                                    <td class="td-center" style="width: 8%;">
                                                                        <input type="radio" id="muc_1"
                                                                            name="muc_{{$x->maCDR3}}" value="1"
                                                                            title="Nhớ"> 
                                                                    </td>
                                                                    <td class="td-center" style="width: 8%;">
                                                                        <input type="radio" id="muc_2"
                                                                            name="muc_{{ $x->maCDR3}}" value="2"
                                                                            title="Hiểu">
                                                                    </td>
                                                                    <td class="td-center" style="width: 8%;">
                                                                        <input type="radio" id="muc_3"
                                                                            name="muc_{{ $x->maCDR3 }}" value="3"
                                                                            title="Vận dụng">
                                                                    </td>
                                                                    <td class="td-center" style="width: 8%;">
                                                                        <input type="radio" id="muc_4"
                                                                            name="muc_{{ $x->maCDR3 }}" value="4"
                                                                            title="Phân tích">
                                                                    </td>
                                                                    <td class="td-center" style="width: 8%;">
                                                                        <input type="radio" id="muc_5"
                                                                            name="muc_{{ $x->maCDR3 }}" value="5"
                                                                            title="Đánh giá">
                                                                    </td>
                                                                    <td class="td-center" style="width: 8%;">
                                                                        <input type="radio" id="muc_6"
                                                                            name="muc_{{ $x->maCDR3 }}" value="6"
                                                                            title="Sáng tạo">
                                                                    </td>
                                                                </tr>
                                                         @endif 
                                    ...
                                    {{-- <a class="btn btn-success" onclick="return confirm('Bạn có muốn gửi khảo sát không ?')" href="{{ asset('/sinh-vien/khao-sat-ctdt/khao-sat-cdr3/guiks-ctdt/'.$lop->maLop) }}">Gui</i></a> --}}
        ...
        $(document).ready(function() {
            ...
            $('#submit').click(function(e) { //khi bam gui
                ...
                $.each(data, function(i, v) //chay tung phan tu trong mang json
                    {
                        //kiem tra radio button da duoc chon 
                        if ($('input[type="radio"][name="' + 'muc_' + v['maCDR3'] + '"]').is(
                                ':checked') == false) {
                            demFalse += 1;
                            ktra.push(v['maCDR3VB']);
                        }
                    });
                ...
                if (demFalse > 0) {
                    ...
                    $('tbody').animate({scrollTop: divPosition.top}, 900);//"slow"
                    return false;
                } else {
                    $.ajax({
                        url: "{{ asset('/sinh-vien/khao-sat-ctdt/khao-sat-cdr3/guiks-ctdt/'.$lop->maLop) }}",
                        method: 'post',
