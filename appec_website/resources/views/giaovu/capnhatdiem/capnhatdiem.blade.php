                                                ...
                                                <thead>
                                                    <tr role="row">
                                                        ...
                                                        <th class="sorting" tabindex="0" aria-controls="example2"
                                                            rowspan="1" colspan="1"
                                                            aria-label="Tên học phần: activate to sort column ascending">Tên
                                                            học phần</th>
                                                        <th class="sorting" tabindex="0" aria-controls="example2"
                                                            rowspan="1" colspan="1"
                                                            aria-label="Giảng viên hướng dẫn: activate to sort column ascending">
                                                            Giảng viên hướng dẫn</th>
                                                        <th class="sorting" tabindex="0" aria-controls="example2"
                                                            rowspan="1" colspan="1"
                                                            aria-label="Ngành: activate to sort column ascending">Ngành</th>
                                                        <th class="sorting" tabindex="0" aria-controls="example2"
                                                            rowspan="1" colspan="1"
                                                            aria-label="Học kì: activate to sort column ascending">Học kì
                                                        </th>
                                                        <th class="sorting" tabindex="0" aria-controls="example2"
                                                            rowspan="1" colspan="1"
                                                            aria-label="Năm học: activate to sort column ascending">Năm học
                                                        </th>
                                                        <th class="sorting" tabindex="0" aria-controls="example2"
                                                            rowspan="1" colspan="1"
                                                        ...
                                                        <td>
                                                            <a href="diemtheohocphan_1.html">
                                                                <button class="btn btn-primary">
                                                                    <i class="fas fa-align-justify"></i> Cập nhật điểm theo
                                                                    nội dung đánh giá
                                                                </button>
                                                            </a>
                                                        </td>
