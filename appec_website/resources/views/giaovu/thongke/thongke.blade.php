                      ...
                      @endphp
                        <tr>
                          ...
                          <td>
                            ...
                            @if ($dem>1)
                              <a href="{{ asset('/giao-vu/thong-ke/thong-ke-theo-hoc-phan/00000/'.$gd->maHocPhan.'/'.$gd->maHK.'/'.$gd->namHoc.'/'.$gd->maLop) }}">
                                <button class="btn btn-primary"> 
                                  <i class="fas fa-chart-line"></i>Thống kê
                                </button>
                              </a>
                            @else
                                <a href="{{ asset('/giao-vu/thong-ke/thong-ke-theo-hoc-phan/'.$maGV.'/'.$gd->maHocPhan.'/'.$gd->maHK.'/'.$gd->namHoc.'/'.$gd->maLop) }}">
                                  <button class="btn btn-primary"> 
                                    <i class="fas fa-chart-line"></i>Thống kê
                                  </button>
                                </a>
