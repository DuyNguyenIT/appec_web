            ...
            <div class="col-12">
              <div class="card">
                <div class="card-header">
                  <h3 class="card-title">
                      {{ __('Course') }}: {{ $hocphan->tenHocPhan }} {{ __('Semester') }}: {{ $maHK }}
                  </h3>
                  <div class="card-tools">
                    <a href="{{ asset('/giao-vu/hoc-phan-giang-day') }}" class="btn btn-secondary"><i class="fas fa-arrow-left"></i></a>
                  </div>
                </div>
                <div class="card-header">
                ...
                <div class="modal fade" id="importExcel" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                  <div class="modal-dialog" role="document">
                    <form action="{{ asset('/giao-vu/hoc-phan-giang-day/cap-nhat-ds-sinh-vien-bang-excel') }}" enctype="multipart/form-data" method="post">
                    @csrf
