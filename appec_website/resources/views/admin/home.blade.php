                ...
                <div class="row">
                    ...
                    <div class="col-lg-2 col-6">
                        <div class="small-box bg-gradient-warning">
                            ...
                            <a href="{{ asset('quan-ly/chuyen-nganh') }}"
                                class="small-box-footer">{{ __('Details') }}<i class="fas fa-arrow-circle-right"></i>
                            </a>
                        </div>
                    </div>
                    <!--------------------------------------------------- -->
                    ...
                    <div class="col-lg-2 col-6">
                        <div class="small-box bg-gradient-orange">
                            ...
                            <a href="{{ asset('quan-ly/he') }}" class="small-box-footer">{{ __('Details') }}<i
                                    class="fas fa-arrow-circle-right"></i>
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-2 col-6">
                        <div class="small-box bg-gradient-maroon">
                            ...
                            <a href="{{ asset('quan-ly/chuong-trinh-dao-tao') }}"
                                class="small-box-footer">{{ __('Details') }}<i class="fas fa-arrow-circle-right"></i>
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-2 col-6">
                        <div class="small-box bg-gradient-dark">
                            ...
                            <a href="{{ asset('quan-ly/loai-hoc-phan') }}"
                                class="small-box-footer">{{ __('Details') }}<i class="fas fa-arrow-circle-right"></i>
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-2 col-6">
                        <div class="small-box bg-gradient-indigo">
                            ...
                            <a href="{{ asset('quan-ly/khoi-kien-thuc') }}" class="small-box-footer">
                                {{ __('Details') }} <i class="fas fa-arrow-circle-right"></i> </a>
                        </div>
                    </div>
                    <!-- ./col -->
                    <!-- ---------------------cột 10------------------------ -->
                    <div class="col-lg-2 col-6">
                        <div class="small-box bg-gradient-teal">
                            ...
                            <a href="{{ asset('quan-ly/phuong-phap-giang-day') }}"
                                class="small-box-footer">{{ __('Details') }}<i class="fas fa-arrow-circle-right"></i>
                            </a>
                        </div>
                    </div>
