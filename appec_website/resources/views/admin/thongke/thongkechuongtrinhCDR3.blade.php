    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark">{{ $ctdt->tenCT }}<noscript></noscript>
                            <nav></nav>
                        </h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item "><a
                                    href="{{ asset('/quan-ly/thong-ke') }}">{{ __('Statistics') }}</a></li>
                                ...
                                <table id="" class="table table-bordered table-hover table-responsive table-striped">
                                    ...
                                    <tfoot>
                                        <tr>
                                            ...
                                            @foreach ($ctdt_cdr as $x)
                                                <td class="fifth" bgcolor="#28a745">
                                                    <font color="white"><b>{{ $tongmon_dapung[$x->maCDR3] }}</b></font>
                                                </td>
                                            @endforeach
                                            <td class="fifth" bgcolor="#28a745">
                                                <font color="yellow"><b>{{ $tongcong }}</b></font>
                                            </td>
                                        </tr>
                                    </tfoot>
                                </table>
