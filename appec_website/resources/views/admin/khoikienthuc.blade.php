                                                ...
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="exampleModalLabel">
                                                            {{ __('Adding a new') }} {{ __('knowledge block') }}</h5>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <button title="Edit" class="btn btn-primary" data-toggle="modal"
                                                        data-target="#edit_{{ $x->maKhoiKT }}">
                                                        <i class="fas fa-edit"></i>
                                                    </button>
                                                    {{-- delete button --}}
                                                    <a title="Delete" class="btn btn-danger"
                                                        onclick="return confirm('Do you want to delete {{ $x->maKhoiKT }}?')"
                                                        href="{{ asset('quan-ly/khoi-kien-thuc/xoa/' . $x->maKhoiKT) }}"><i
                                                            class="fa fa-trash"></i></a>
                                                    <!-- Modal edit-->
                                                    <div class="modal fade" id="edit_{{ $x->maKhoiKT }}" tabindex="-1"
                                                        role="dialog" aria-labelledby="exampleModalLabel"
                                                        aria-hidden="true">
                                                        <div class="modal-dialog" role="document">
                                                            <form action="{{ asset('quan-ly/khoi-kien-thuc/sua') }}"
                                                                method="post">
                                                                @csrf
                                                                <div class="modal-content">
                                                                    <div class="modal-header">
                                                                    ...
                                                                    <div class="modal-body">
                                                                        <input type="text" hidden name="maKhoiKT"
                                                                            value="{{ $x->maKhoiKT }}"
                                                                            class="form-control">
                                                                        <div class="form-group">
                                                                            <label
                                                                                for="">{{ __('Knowledge block name') }}</label>
