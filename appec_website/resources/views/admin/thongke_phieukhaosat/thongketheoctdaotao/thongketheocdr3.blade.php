  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Thống kê theo Chuẩn đầu ra 3<noscript></noscript><nav></nav></h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              {{-- <li class="breadcrumb-item "><a href="thongketheohocphan.html"></a></li> --}}
              <li class="breadcrumb-item active">Thống kê theo Chuẩn đầu ra 3</li>
...
<script>
  $(function () {
     ...
     $.ajax({
         type:'GET',
         url:"{{ asset('/quan-ly/thong-ke/thong-ke-theo-lop/get-cdr3/'.$lop->maLop) }}",
