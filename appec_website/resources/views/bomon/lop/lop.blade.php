    ...
    <div class="content-wrapper" style="min-height: 155px;">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark">Quản lý lớp<noscript></noscript>
                            <nav></nav>
                        </h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                                ...
                                <h3 class="card-title">
                                    ...
                                    <div class="modal fade" id="addClass" tabindex="-1" role="dialog"
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <form action="{{ asset('/bo-mon/quan-ly-lop/them-lop') }}" method="post">
                                                @csrf
                                                        ...
                                                        <tr role="row" class="odd">
                                                            ...
                                                            <td>
                                                                <a class="btn bg-success"
                                                                    href="{{ asset('bo-mon/quan-ly-lop/xem-danh-sach-sinh-vien/' . $lp->maLop) }}">
                                                                    <span
                                                                ...
                                                                <div class="modal fade" id="edit_{{ $lp->maLop }}"
                                                                    ...
                                                                    <div class="modal-dialog" role="document">
                                                                        <form
                                                                            action="{{ asset('/bo-mon/quan-ly-lop/sua-lop') }}"
                                                                            method="post">
                                                                            @csrf
                                                                            <div class="modal-content">
                                                                                <div class="modal-header">
                                                                ...
                                                                <div class="btn-group">
                                                                    ...
                                                                    <a class="btn btn-danger"
                                                                        href="{{ asset('/bo-mon/quan-ly-lop/xoa-lop/' . $lp->maLop) }}"
