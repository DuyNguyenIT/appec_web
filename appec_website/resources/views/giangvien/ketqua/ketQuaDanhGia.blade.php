      ...
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0 text-dark">
            Kết quả đánh giá<noscript></noscript>
            <nav></nav>
          </h1>
        </div>
        <!-- /.col -->
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item active">Kết quả học tập học phần</li>
          </ol>
        </div>
        <!-- /.col -->
      </div>
                ...
                <tr >
                  ...
                  @foreach ($gd as $item)
                    ...
                    <td>
                      ...
                      <td>
                        <a href="{{ asset('giang-vien/ket-qua-danh-gia/ket-qua-hoc-phan/'.$item->maHocPhan.'/'.$item->maBaiQH.'/'.$item->maHK.'/'.$item->namHoc.'/'.$item->maLop) }}" class="btn btn-success">
