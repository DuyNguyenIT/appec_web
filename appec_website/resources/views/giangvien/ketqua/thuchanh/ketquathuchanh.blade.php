                    ...
                    <div class="card-header">
                      <h4 class="">
                            ...
                            <div class="modal fade" id="addOne" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                ...
                                <form action="{{ asset('/giang-vien/ket-qua-danh-gia/thuc-hanh/them-mot-phieu-cham') }}" method="post">
                                @csrf
                            ...
                            <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                              ...
                              <div class="modal-dialog" role="document">
                                <form action="{{ asset('/giang-vien/ket-qua-danh-gia/thuc-hanh/them-nhieu-phieu-cham') }}" method="post">
                                  @csrf
                                  <div class="modal-content">
                                    <div class="modal-header">
                        ...
                        <tbody>
                          ...
                          @foreach ($phieucham as $data)
                              <tr>
                                ...
                                <td>
                                  @if ($data->trangThai==true)
                                  <a href="{{ asset('/giang-vien/ket-qua-danh-gia/thuc-hanh/xem-ket-qua-danh-gia-thuc-hanh/'.$data->maDe.'/'.$data->maSSV) }}" class="btn btn-primary">Xem KQ</a>
                                  @else
                                  <a href="{{ asset('/giang-vien/ket-qua-danh-gia/thuc-hanh/nhap-diem-thuc-hanh/'.$data->maDe.'/'.$data->maSSV) }}" class="btn btn-primary">Chấm</a>
                                  @endif
                                </td>
                            </tr>
                          @endforeach
