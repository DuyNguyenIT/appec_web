  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Phiếu đánh giá đồ án<noscript></noscript><nav></nav></h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
                     ...
                     <tbody>
                       ...
                       @if ($chayTieuChuan==1)
                          <tr>
                            ...
                            <td rowspan={{$demTieuChi_TCDG}}>{{$tc->tenTCDG}} <b>({{$tc->diem}} điểm)</b></td>
                            @if ($chayCDR_TCDG==1)
                            ...
                            @endif
                            <td>
                              <input type="checkbox"  name="chamdiem[]" value="{{$tc->maTCCD}}"/>
                            </td>
                          </tr>
                       @else
                          <tr>
