...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0 text-dark">Phiếu đánh giá trắc nghiệm<noscript></noscript><nav></nav></h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
      ...
      <section class="content">
        <div class="container-fluid">
          <div class="row">
            <div class="col-12">
              <!-- /.card -->
              <form action="{{ asset('/giang-vien/ket-qua-danh-gia/trac-nghiem/cham-diem-submit') }}" method="post">
                @csrf
                     ...
                     <tbody>
                       ...
                       @if ($chayCauHoi==1)
                          <tr>
                            ...
                            <td rowspan={{$demPA_CauHoi}}>{!! $tc->noiDungCauHoi !!} <b>( {{  $diemCauHoi['diem'] }}  điểm)</b></td>
                            @if ($chayCDR_PATL==1)
                            ...
                            @endif
                            <td>
                              <input type="radio" id="{{ $tc->maCauHoi }}"  name="chon_{{ $tc->maCauHoi }}" value="{{$tc->id}}"/>
                            </td>
                          </tr>
                       @else
                          <tr>
