                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item "><a href="#">{{ __('Assessment') }}</a></li>
                            <li class="breadcrumb-item "><a href="#">Multiple choice</a></li>
                            <li class="breadcrumb-item active">{{ __('Multiple choice answer sheet') }}</li>
                        </ol>
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12">
                        ...
                        <form action="{{ asset('/giang-vien/ket-qua-danh-gia/trac-nghiem/sua-diem-trac-nghiem-submit') }}">

                        <input type="text" name="maPhieuCham" hidden value={{ $gv->maPhieuCham }}>
                        <div class="card">
                            <div class="card-header">
                                <h5 class="card-title">
                                    1. {{ __('Lecture') }}: {{ $gv->hoGV }} {{ $gv->tenGV }} <br>
                                    
                                    2. {{ __("Exame ID") }}: {{ $dethi->tenDe }} <br>
                                    3. {{ __('student name') }}: {{ $sv->HoSV }} {{ $sv->TenSV }} <br>
                                </h5>
