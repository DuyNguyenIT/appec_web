                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item "><a href="#">Essay</a></li>
                            <li class="breadcrumb-item active">Answer sheet</li>
                        </ol>
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
                                ...
                                <table id="example2" class="table table-bordered table-hover">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>{{ __('Answer') }}</th>
                                            <th>{{ __('Granding') }} </th>
                                            <th>Check <input type="checkbox" name="" id="selectAll"></th>
                                            <script>
