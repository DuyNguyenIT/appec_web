    ...
    <section class="content">
        <div class="container-fluid">
          <div class="row">
            <div class="col-12">
              <!-- /.card -->
              <form action="{{ asset('/giang-vien/ket-qua-danh-gia/thuc-hanh/cham-diem-submit') }}" method="post">
                @csrf
                     ...
                     <tbody>
                       ...
                       @if ($chayCauHoi==1)
                          <tr>
                            ...
                            <td rowspan={{$demPA_CauHoi}}>{!! $tc->noiDungCauHoi !!} <b>( {{  $diemCauHoi }}  điểm)</b></td>
                            @if ($chayCDR_PATL==1)
                            ...
                            @endif
                            <td>
                              <input type="checkbox"  name="chamdiem[]" value="{{$tc->maPATL}}"/>
                            </td>
                          </tr>
                       @else
                          <tr>
