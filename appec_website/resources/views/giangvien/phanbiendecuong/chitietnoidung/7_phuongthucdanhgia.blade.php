...
<div class="modal fade" id="addHocPhan_loaiHTDG" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    ...
    <div class="modal-dialog" role="document">
        <form action="{{ asset('/giang-vien/phan-bien-de-cuong/them_phuong_phap_danh_gia') }}" method="post">
            @csrf
    ...
    <tbody>
        ...
        @foreach ($hocPhan_loaiHTDG as $data)
            <tr>
                ...
                <td>
                    ...
                    <a title="Delete" class="btn btn-danger"
                        ...
                        href="{{ asset('/giang-vien/phan-bien-de-cuong/xoa_phuong_phap_danh_gia/'.$data->id) }}">
                ...
                <td>
                    ...
                    @if ($data->hp_loaihtdg_kqht)
                        @foreach ($data->hp_loaihtdg_kqht as $t)
                            ...
                            onclick="return confirm('Confirm?')"
                            href="{{ asset('/giang-vien/phan-bien-de-cuong/xoa_hocphan_loaihtdg_kqht/'.$t->id) }}">
                         <i class="fa fa-trash"></i>
                     </a>;
                        @endforeach
                    @endif
                    ...
                    <div class="modal fade" id="add_{{ $data->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog" role="document">
                        <form action="{{ asset('/giang-vien/phan-bien-de-cuong/them_hocphan_loaihtdg_kqht') }}" method="post">
                        @csrf
                            <div class="modal-content">
                                <div class="modal-header">
            ...
            <div class="modal fade" id="edit_{{ $data->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <form action="{{ asset('/giang-vien/phan-bien-de-cuong/sua_phuong_phap_danh_gia') }}" method="post">
                    @csrf
                    <div class="modal-content">
