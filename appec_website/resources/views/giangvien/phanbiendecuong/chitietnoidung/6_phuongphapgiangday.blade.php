...
<div class="modal fade" id="ppgiangday" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    ...
    <div class="modal-dialog" role="document">
        <form action="{{ asset('/giang-vien/phan-bien-de-cuong/them_phuong_phap_giang_day') }}" method="post">
            @csrf
            ...
            <tr>
                ...
                <td>
                    <a title="Delete" class="btn btn-danger"
                        ...
                        href="{{ asset('/giang-vien/phan-bien-de-cuong/xoa-phuong-phap-giang-day/'.$data->id) }}">
