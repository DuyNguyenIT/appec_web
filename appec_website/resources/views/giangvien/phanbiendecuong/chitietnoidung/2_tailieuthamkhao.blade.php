        ...
        <td>
            ...
            <div class="modal fade" id="addgiaoTrinh" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                ...
                <div class="modal-dialog modal-lg" role="document">
                    <form action="{{ asset('/giang-vien/phan-bien-de-cuong/sua_giao_trinh') }}" method="post">
                        @csrf
    ...
    <tr>
        ...
        <td>
            ...
            <div class="modal fade" id="addthamKhaoThem" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                aria-hidden="true">
                <div class="modal-dialog modal-lg" role="document">
                    <form action="{{ asset('/giang-vien/phan-bien-de-cuong/sua_tai_lieu_tham_khao_them') }}"
                        method="post">
                        @csrf
                        <div class="modal-content">
                            <div class="modal-header">
    ...
    <tr>
        ...
        <td>
            ...
            <div class="modal fade" id="addtaiLieuKhac" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                aria-hidden="true">
                <div class="modal-dialog modal-lg" role="document">
                    <form action="{{ asset('/giang-vien/phan-bien-de-cuong/sua_tai_lieu_khac') }}" method="post">
                        @csrf
                        <div class="modal-content">
                            <div class="modal-header">
