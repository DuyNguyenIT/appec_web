                ...
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark">
                            Adding group evaluation criteria<noscript></noscript>
                            <nav></nav>
                        </h1>
                    </div>
                    <!-- /.col -->
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">Assessment planning</li>
                            <li class="breadcrumb-item active">Project</li>
                            <li class="breadcrumb-item active">Adding group evaluation criteria</li>
                        </ol>
                    </div>
                    <!-- /.col -->
                </div>
                        ...
                        <form action="{{ asset('giang-vien/quy-hoach-danh-gia/noi-dung-danh-gia/them-tieu-chi-submit') }}"
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        <label for="">{{ __('Standard') }} (Follow the order of group evaluation criteria):</label>
                                        <div class="row">
                                            <div class="col-md-6">
                                            ...
                                            <div class="col-md-2">
                                                <button type="button" href="" class="btn btn-primary" data-toggle="modal"
                                                    ...
                                                    {{ __('Add') }} Classify assessment
                                                </button>
                                                
                                            </div>
                                            <div class="col-md-4">
                                                <button type="button" class="btn btn-danger" id="delStand">
                                                    {{ __('Delete') }} Classify assessment
                                                </button>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <hr>
                                    <div class="form-group">
                                        <label for="">Choose the number of Evaluation criteria:</label>
                                        ...
                                        <table class="table table-striped">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th>Evaluation criteria's content</th>
                                                    <th>Marh</th>
                                                </tr>
                                            </thead>
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <div class="form-group">
                                                <label for=""> Add Classify assessment:</label>
