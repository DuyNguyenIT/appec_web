                   ...
                   @foreach ($noiDungQH as $nd)
                    <tr>
                      ...
                      <td>
                        ...
                        <div class="btn-group">
                          <!-- Button edit modal -->
                          <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#edit_{{ $nd->maNoiDungQH }}">
                              <i class="fas fa-edit"></i>
                          </button>

                          <a class="btn btn-danger" onclick=" return confirm('Confirm?')" href="{{ asset('/giang-vien/quy-hoach-danh-gia/noi-dung-quy-hoach/xoa-noi-dung-quy-hoach/'.$nd->maNoiDungQH) }}">
                              <i class="fas fa-trash"></i>
                          </a>
                        </div>

                        <!-- Modal edit-->
                        <div class="modal fade" id="edit_{{ $nd->maNoiDungQH }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                          <div class="modal-dialog" role="document">
                            <form action="{{ asset('/giang-vien/quy-hoach-danh-gia/noi-dung-quy-hoach/sua-noi-dung-quy-hoach-submit') }}" method="post">
                            @csrf
                            <div class="modal-content">
                              <div class="modal-header">
                              ...
                              <div class="modal-body">
                                <input type="text" name="maNoiDungQH" value="{{ $nd->maNoiDungQH }}" hidden>
                                <div class="form-group">
                                  <label for="">Tên nội dung quy hoạch</label>
                                  <input type="text" name="tenNoiDungQH" class="form-control" value="{{ $nd->tenNoiDungQH }}" required>
                                </div>
                              </div>
                              <div class="modal-footer">
