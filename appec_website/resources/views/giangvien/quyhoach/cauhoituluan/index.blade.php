                            ...
                            <div class="card-header">
                                ...
                                <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog"
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <form
                                            action="{{ asset('/giang-vien/quy-hoach-danh-gia/noi-dung-quy-hoach/chuong/them-chuong-noi-dung-quy-hoach') }}"
                                            method="post">
                                            @csrf
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="exampleModalLabel">Chọn chương quy hoạch
                                                    </h5>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select name="id_chuong" id="" class="form-control">
                                                            @foreach ($chuong_hp as $item)
                                                                <option value="{{ $item->id }}">{{ $item->tenchuong }}
                                                                </option>
