                            ...
                            <div class="card-header">
                                ...
                                <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog"
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <form
                                            action="{{ asset('/giang-vien/quy-hoach-danh-gia/noi-dung-danh-gia/them-de-thi-tu-luan-submit') }}"
                                            method="post">
                                            @csrf
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="exampleModalLabel">{{ _('Adding a new exame') }}</h5>
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($dethi as $data)
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="btn-group">
                                                        <a href="{{ asset('/giang-vien/quy-hoach-danh-gia/noi-dung-danh-gia/xem-noi-dung-danh-gia/cau-truc-de-tu-luan/' . $data->maDe) }}"
                                                        ...
                                                        <a href="{{ asset('/giang-vien/quy-hoach-danh-gia/noi-dung-danh-gia/xem-noi-dung-danh-gia/xoa-de-tu-luan/'.$data->maDe) }}" onclick="return confirm('Confirm?')" class="btn btn-danger"><i class="fas fa-trash"></i></a>
                                                    </div>
                                                    <!-- Modal edit-->
                                                    <div class="modal fade" id="edit_{{ $data->maDe }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                ...
                                                                <div class="form-group">
                                                                    <label for="">{{ __('Duration') }} ({{ __('minutes') }})</label>
                                                                    <input type="number" class="form-control" name="thoiGian" value="{{ $data->thoiGian }}" min="30"
                                                                        max="180">
                                                                </div>
                                                                <div class="form-group">
                                                                    <label for="">{{ __('The number of question') }}</label>
                                                                    <input type="number" class="form-control" name="soCauHoi" value="{{ $data->soCauHoi }}" min="1"
                                                                        required>
                                                                </div>
                                                                <div class="form-group">
                                                                    <label for="">{{ __('Note') }}</label>
