                        ...
                        <tbody>
                          ...
                          @foreach ($dethi as $data)
                              <tr>
                                ...
                                <td>{{ $data->ghiChu }}</td>
                                <td>
                                  <a href="{{ asset('/giang-vien/quy-hoach-danh-gia/noi-dung-danh-gia/xem-noi-dung-danh-gia/cau-truc-de-tu-luan/'.$data->maDe) }}" class="btn btn-primary">Cấu trúc nội dung</a>
