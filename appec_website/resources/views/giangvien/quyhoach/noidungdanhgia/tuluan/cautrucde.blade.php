                          ...
                          <!-- Modal -->
                            <div class="modal fade" id="editPA_{{ $data->phuongAn[$k]->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                              <div class="modal-dialog modal-lg" role="document">
                                <form action="{{ asset('/giang-vien/quy-hoach-danh-gia/noi-dung-danh-gia/xem-noi-dung-danh-gia/sua-phuong-an-tu-luan') }}" method="post">
                                @csrf
                                <div class="modal-content">
                                  ...
                                  <div class="modal-body">
                                    ...
                                    <div class="form-group">
                                      ...
                                      <input type="text" name="diemPA" value="{{ $data->phuongAn[$k]->diemPA }}">
                                    </div>
                                    <div class="from-group">
