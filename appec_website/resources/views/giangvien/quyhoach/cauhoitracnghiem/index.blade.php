        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item ">
                ...
                {{ $muc->maMucVB }} {{\Illuminate\Support\Str::limit(html_entity_decode($muc->tenMuc),$limit=20,$end='...')}}  
            </li>
          ...
          <div class="card">
            <div class="card-header">
              <h3 class="d-flex justify-content-between">
                <a href="{{ asset('giang-vien/quy-hoach-danh-gia/noi-dung-danh-gia/ngan-hang-cau-hoi-trac-nghiem/them-cau-hoi') }}" class="btn btn-primary"><i class="fas fa-plus"></i></a>
