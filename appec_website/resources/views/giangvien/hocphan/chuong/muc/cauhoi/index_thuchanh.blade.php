                            ...
                            <div class="card-header">
                                ...
                                <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog"
                                    ...
                                    <div class="modal-dialog modal-lg" role="document">
                                        <form
                                            action="{{ asset('/giang-vien/hoc-phan/chuong/muc/cau-hoi-thuc-hanh/them') }}"
                                            method="post">
                                            @csrf
                                                    ...
                                                    <td>
                                                        <div class="btn-group">
                                                            ...
                                                            <a class="btn btn-danger" onclick="return confirm('Confirm?')"
                                                                href="{{ asset('/giang-vien/hoc-phan/chuong/muc/cau-hoi-thuc-hanh/xoa/' . $x->maCauHoi) }}">
                                                        ...
                                                        <div class="modal fade" id="edit_{{ $x->maCauHoi }}"
                                                            ...
                                                            <div class="modal-dialog modal-lg" role="document">
                                                                <form
                                                                    action="{{ asset('/giang-vien/hoc-phan/chuong/muc/cau-hoi-thuc-hanh/sua') }}"
                                                                    method="post">
                                                                    @csrf
                                                                    <div class="modal-content">
                                                                        <div class="modal-header">
