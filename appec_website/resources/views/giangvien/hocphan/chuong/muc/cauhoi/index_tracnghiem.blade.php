                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">
                                    <a href="{{ asset('/giang-vien/hoc-phan/chuong/muc/them-cau-hoi-trac-nghiem/?maMuc=' . Session::get('maMuc')) }}"
                                    ...
                                    <!-- Modal -->
                                    <div class="modal fade" id="addCHTN" tabindex="-1" role="dialog"
                                        aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <div class="modal-dialog modal-lg" role="document">
                                            <form
                                                action="{{ asset('/giang-vien/hoc-phan/chuong/muc/cau-hoi-trac-nghiem/them') }}"
                                                method="post">
                                                @csrf
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="exampleModalLabel">Adding a new multiple
                                                            choice question</h5>
                                                    ...
                                                    <div class="modal-body">
                                                        <div class="form-group">
                                                            <label for="">Adding content of multiple choice
                                                                question:</label>
                                                            <textarea name="noiDungCauHoi" id="ndch" cols="30" rows="10"
                                                        ...
                                                        <div class="form-group">
                                                            <div class="row">
                                                                <div class="col-md-10">
                                                                    ...
                                                                    <textarea name="phuongAn[]" id="pa1" cols="30" rows="10"
                                                                        class="form-control" required></textarea>
                                                                    <script>
                                                                ...
                                                                <div class="col-md-2">
                                                                    ...
                                                                    <input type="radio" name="choice" class="form-control"
                                                                        value="0" checked>
                                                                    <label for="">Point</label>
                                                                    <input type="text" name="diemPA[]" class="form-control"
                                                                        required>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <div class="row">
                                                                <div class="col-md-10">
                                                                    ...
                                                                    <textarea name="phuongAn[]" id="pa2" cols="30" rows="10"
                                                                        class="form-control" required></textarea>
                                                                    <script>
                                                        ...
                                                        <div class="form-group">
                                                            <div class="row">
                                                                <div class="col-md-10">
                                                                    ...
                                                                    <textarea name="phuongAn[]" id="pa3" cols="30" rows="10"
                                                                        class="form-control" required></textarea>
                                                                    <script>
                                                        ...
                                                        <div class="form-group">
                                                            <div class="row">
                                                                <div class="col-md-10">
                                                                    ...
                                                                    <textarea name="phuongAn[]" id="pa4" cols="30" rows="10"
                                                                        class="form-control" required></textarea>
                                                                    <script>
                                        ...
                                        @foreach ($cauHoi as $data)
                                            <tr>
                                                ...
                                                <td>
                                                    <!-- Button trigger modal -->
                                                    <button type="button" class="btn btn-primary" data-toggle="modal"
                                                        data-target="#editCHTN_{{ $data->maCauHoi }}">
                                                        <i class="fas fa-edit"></i>
                                                    </button>
                                                    <!-- Modal -->
                                                    <div class="modal fade" id="editCHTN_{{ $data->maCauHoi }}"
                                                        tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                                                        aria-hidden="true">
                                                        <div class="modal-dialog modal-lg" role="document">
                                                            <form
                                                                action="{{ asset('/giang-vien/hoc-phan/chuong/muc/cau-hoi-trac-nghiem/sua') }}"
                                                                method="post">
                                                                @csrf
                                                                ...
                                                                <div class="modal-content">
                                                                    <div class="modal-header">
                                                                        ...
                                                                        <h5 class="modal-title" id="exampleModalLabel">
                                                                            Editing a multiple choice question</h5>
                                                                    ...
                                                                    <div class="modal-body">
                                                                        <div class="form-group">
                                                                            <label for="">Editing content of multiple choice
                                                                                question:</label>
                                                    ...
                                                    {{ $data->noiDungCauHoi }}
                                                                        ...
                                                                        <div class="form-group">
                                                                            <input type="text" name="maPhuongAn[]"
                                                                                value="{{ $data->phuong_an_trac_nghiem[0]->id }}"
                                                                                hidden>
                                                                            <div class="row">
                                                                                <div class="col-md-10">
                                                                                    <label for="">Adding a new answer
                                                                                        contents (A):</label>
                                                                                    <textarea name="phuongAn[]"
                                                      ...
                                                      {{ $data->phuong_an_trac_nghiem[0]->noiDungPA }}
                                                                                ...
                                                                                <div class="col-md-2">
                                                                                    <label for="">Check if correct answer
                                                                                    </label>
                                                                                    ...
                                                                                    <input type="text" name="diemPA[]"
                                                                                        class="form-control" required
                                                                                        value="{{ $data->phuong_an_trac_nghiem[0]->diemPA }}">
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        {{-- -----------------------------------B---------------------------------- --}}
                                                                        <div class="form-group">
                                                                            <input type="text" name="maPhuongAn[]"
                                                                                value="{{ $data->phuong_an_trac_nghiem[1]->id }}"
                                                                                hidden>
                                                                            <div class="row">
                                                                                <div class="col-md-10">
                                                                                    <label for="">Adding a new answer
                                                      ...
                                                      {{ $data->phuong_an_trac_nghiem[1]->noiDungPA }}
                                                                                ...
                                                                                <div class="col-md-2">
                                                                                    ...
                                                                                    <input type="text" name="diemPA[]"
                                                                                        class="form-control" required
                                                                                        value="{{ $data->phuong_an_trac_nghiem[1]->diemPA }}">
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        {{-- ---------------------------------C--------------------------------- --}}
                                                                        <div class="form-group">
                                                                            <input type="text" name="maPhuongAn[]"
                                                                                value="{{ $data->phuong_an_trac_nghiem[2]->id }}"
                                                                                hidden>
                                                                            <div class="row">
                                                                                <div class="col-md-10">
                                                                                    <label for="">Adding a new answer
                                                      ...
                                                      {{ $data->phuong_an_trac_nghiem[2]->noiDungPA }}
                                                                                ...
                                                                                <div class="col-md-2">
                                                                                    ...
                                                                                    <input type="text" name="diemPA[]"
                                                                                        class="form-control" required
                                                                                        value="{{ $data->phuong_an_trac_nghiem[2]->diemPA }}">
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        {{-- -------------------------------D----------------------------- --}}
                                                                        <div class="form-group">
                                                                            <input type="text" name="maPhuongAn[]"
                                                                                value="{{ $data->phuong_an_trac_nghiem[3]->id }}"
                                                                                hidden>
                                                                            <div class="row">
                                                                                <div class="col-md-10">
                                                                                    <label for="">Adding a new answer
                                                      ...
                                                      {{ $data->phuong_an_trac_nghiem[3]->noiDungPA }}
                                                                                ...
                                                                                <div class="col-md-2">
                                                                                    ...
                                                                                    <input type="text" name="diemPA[]"
                                                                                        class="form-control" required
                                                                                        value="{{ $data->phuong_an_trac_nghiem[3]->diemPA }}">
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        {{-- -----------------------------Chuẩn đầu ra----------------------------- --}}
