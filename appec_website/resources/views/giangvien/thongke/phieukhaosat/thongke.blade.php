...
<div class="content-wrapper" style="min-height: 155px;">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0 text-dark">Thống kê<noscript></noscript><nav></nav></h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
                    ...
                    @foreach ($giangday as $gd)
                      ...
                      @endphp
                        <tr>
                          ...
                          <td>
                            <a href="{{ asset('/giang-vien/hoc-phan/thong-ke/thong-ke-theo-hocphan/'.$maGV.'/'.$gd->maHocPhan.'/'.$gd->maHK.'/'.$gd->namHoc.'/'.$gd->maLop) }}">
                              <button class="btn btn-primary"> 
                                ...
                                <a href="{{ asset('/quan-ly/thong-ke/thong-ke-theo-cdr3/'.$maGV.'/'.$gd->maHocPhan.'/'.$gd->maHK.'/'.$gd->namHoc.'/'.$gd->maLop) }}">
                                  <button class="btn btn-primary"> 
                                    <i class="fas fa-chart-line"></i>Thống kê theo cdr3
                                  </button>
                                </a>
                                <a href="{{ asset('/quan-ly/thong-ke/thong-ke-theo-chuanabet/'.$maGV.'/'.$gd->maHocPhan.'/'.$gd->maHK.'/'.$gd->namHoc.'/'.$gd->maLop) }}">
                                  <button class="btn btn-primary"> 
                                    <i class="fas fa-chart-line"></i>Thống kê theo chuan abet
                                  </button>
                                </a> --}}
