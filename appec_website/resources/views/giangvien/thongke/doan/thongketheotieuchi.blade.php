...
@section('content')
                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <div class="card-tools">
                                    <a href="{{ asset('/giang-vien/thong-ke/thong-ke-theo-hoc-phan/do-an/xuat-thong-ke-so/'.Session::get('maCTBaiQH')) }}" class="btn btn-success">
    ...
    <script>
        $(function() {
            ...
            $.ajax({
                type: 'GET',
                url: '/giang-vien/thong-ke/thong-ke-theo-hoc-phan/do-an/get-tieu-chi',
