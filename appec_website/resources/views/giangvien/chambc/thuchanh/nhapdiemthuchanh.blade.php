    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark">{{ __('Practice') }}<noscript></noscript>
                            <nav></nav>
                        </h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">Nhập điểm thực hành</li>
                        </ol>
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
        ...
        <section class="content">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12">
                        <!-- /.card -->
                        <form action="{{ asset('/giang-vien/cham-diem-bao-cao/thuc-hanh/cham-diem-submit') }}"
                            method="post">
                            @csrf
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <h5 class="card-title">
                                        ...
                                        4. {{ __('Exam ID') }}: {{ $dethi->tenDe }} <br>
                                        5. Học và tên sinh viên: {{ $sv->HoSV }} {{ $sv->TenSV }} <br>
                                    </h5>
                                    <div class="card-tools">
                                        <a href="{{ asset('/giang-vien/cham-diem-bao-cao/nhap-ket-qua-danh-gia/' . Session::get('maCTBaiQH')) }}"
