...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark">Statistics of ABET's SOs for  
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">Statistics of ABET's SOs</li>
                        </ol>
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <div class="card-tools">
                                    {{-- <a href="{{ asset('/giang-vien/thong-ke/thong-ke-theo-hoc-phan/thuc-hanh/xuat-thong-ke-abet/'.Session::get('maCTBaiQH')) }}" class="btn btn-success">
    ...
    <script>
        $(function() {
            ...
            $.ajax({
                type: 'GET',
                url: '/giang-vien/thong-ke/thong-ke-theo-hoc-phan/thuc-hanh/get-abet',
