...
class thongKeAbetNamExport implements FromView
{
    /**
    ...
    */
    public function view(): View
    {
        ...
        return view('admin.thongkeketquatheonam.abet.view_export_abet_nam',\compact('chuanAbet','arr_thongkeKQ','hocPhan'));
