...
{
    //quan ly bien soan de cuong: ham hien cau truc cay cua chuong trinh dao tao
    ...
    //quan ly bien soan de cuong: ham xem thong tin học phan(input: ma hoc phan, output: thong tin hoc phan)
