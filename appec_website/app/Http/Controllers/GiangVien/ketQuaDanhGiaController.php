...
class ketQuaDanhGiaController extends Controller
{
    ...
    public function nhap_ket_qua_danh_gia($maCTBaiQH)
    {
        ...
        if($loaiHTDG->maLoaiHTDG=="T1"){ //kết quả tự luận
            ...
            $phieucham=$phieucham->sortBy('maSSV');
            //return $phieucham;
    ...
    public function xoa_mot_phieu_cham_thuc_hanh($maPhieuCham)
    {
        $pc=phieu_cham::where('maPhieuCham',$maPhieuCham)->first();
        $ct_pc=danhgia_tuluan::where('maPhieuCham',$maPhieuCham)->get();
        $ct_pc->delete();
        $pc->delete();
