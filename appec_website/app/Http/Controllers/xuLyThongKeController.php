...
class xuLyThongKeController extends Controller
{
    ...
    //--thầy Việt code
    public static function thong_ke_CDR3_2($maCTBaiQH)
    {
        $chuan_dau_ra3=[];
        $chuan_dau_ra3_array=[];
        $phuongan=[];
    ...
    public static function thong_ke_abet($maCTBaiQH)
    {
        ...
        foreach ($chuan_abet as $abet) {
            ...
            $t=new xuLyThongKeController();
            $t->cap_nhat_thongke_abet_hocphan($maCTBaiQH,$abet->maChuanAbet,$dat_A,$dat_B,$dat_C,$dat_D,$cdat);
        }
        return $data;

    }
    //thầy Việt code
    public static function thong_ke_abet2($maCTBaiQH)
    {
        $chuan_abet=[];
        $chuan_abet_array=[];
        $phuongan=[];
    ...
    //thầy việt code
    public static function thong_ke_kqht_clo_th_cuoi1($maCTBaiQH)
    {
        $ket_qua_ht=[];
        $kqht_array=[];
        $phuongan=[];
        ...
        ->join('phieu_cham',function($x){
            $x->on('phieu_cham.maDe','=','de_thi.maDe')
            ->where('phieu_cham.maGV',Session::get('maGV'))
            ->where('phieu_cham.isDelete',false)->where('phieu_cham.loaiCB',1);
        })->get(['phieu_cham.maPhieuCham','phieu_cham.maDe']);
    ...
    public static function thong_ke_kqht_clo_th_cuoi2($maCTBaiQH)
    {
        $ket_qua_ht=[];
        $kqht_array=[];
        $phuongan=[];
    ...
    public static function thong_ke_xep_hang($maCTBaiQH,$maGV)
    {
        $dethi=deThi::where('de_thi.isDelete',false)
         ...
         ->join('phieu_cham',function($x)use($maGV){
             ...
             ->where('phieu_cham.trangThai',true)
             ->where('phieu_cham.isDelete',false);
         })
         ->get(['phieu_cham.maPhieuCham','phieu_cham.xepHang']);
         //xếp hạng
        $xepHang=[];
        for ($i=1; $i <=5 ; $i++) { 
    ...
    public static function thong_ke_clo_do_an($maCTBaiQH,$maCanBo)
    {
        ...
        foreach ($kqht as $kq) {
            ...
            $t=new xuLyThongKeController();
            $t->cap_nhat_thongke_clo_hocphan($maCTBaiQH,$kq->maKQHT,$dat_a,$dat_b,$dat_c,$dat_d,$c_dat,$maCanBo);
        }
        return $data;
    }
    ...
    public static function thong_ke_abet_do_an($maCTBaiQH,$maCanBo)
    {
        ...
        foreach ($ndqh as $key => $x) {
            ...
            ->orderBy('chuan_abet.maChuanAbet')
            ->get(['chuan_abet.maChuanAbet','chuan_abet.maChuanAbetVB','chuan_abet.tenChuanAbet','chuan_abet.tenChuanAbet_EN']);
        ...
        foreach ($chuan_abet as $abet) {
            ...
            array_push($data,$temp);
            $t=new xuLyThongKeController();
            $t->cap_nhat_thongke_abet_hocphan($maCTBaiQH,$abet->maChuanAbet,$gioi,$kha,$tb,$yeu,$kem,$maCanBo);
        }
        return $data;
    }


    public static function cap_nhat_thongke_abet_hocphan($maCTBaiQH,$maChuanAbet,$dat_A,$dat_B,$dat_C,$dat_D,$chuadat,$maCanBo=1)
    {
        //cap nhat bang thongke_abet_hocphan
        $tk=thongke_abet_hocphan::where('maCTBaiQH',$maCTBaiQH)->where('maChuanAbet',$maChuanAbet)->where('maCanBo',$maCanBo)->first();
        if($tk){  //neu da co thong ke truoc do thi cap nhat lai
            ...
            thongke_abet_hocphan::create(['maCTBaiQH'=>$maCTBaiQH,'maChuanAbet'=>$maChuanAbet,'maCanBo'=>$maCanBo,
                'dat_A'=>$dat_A,'dat_B'=>$dat_B,'dat_C'=>$dat_C,'dat_D'=>$dat_D,'chua_dat'=>$chuadat]);
        }
    }

    public static function cap_nhat_thongke_so_hocphan($maCTBaiQH,$maCDR3,$dat_A,$dat_B,$dat_C,$dat_D,$chuadat,$maCanBo=1)
    {
        //cap nhat bang thongke_so_hocphan
        $tk=thongke_so_hocphan::where('maCTBaiQH',$maCTBaiQH)->where('maCDR3',$maCDR3)->where('maCanBo',$maCanBo)->first();
        if($tk){  //neu da co thong ke truoc do thi cap nhat lai
            $tk->dat_A=$dat_A;
            $tk->dat_B=$dat_B;
            $tk->dat_C=$dat_C;
            ...
            thongke_so_hocphan::create(['maCTBaiQH'=>$maCTBaiQH,'maCDR3'=>$maCDR3,'maCanBo'=>$maCanBo,
                'dat_A'=>$dat_A,'dat_B'=>$dat_B,'dat_C'=>$dat_C,'dat_D'=>$dat_D,'chua_dat'=>$chuadat]);
        }
    }

    public static function cap_nhat_thongke_clo_hocphan($maCTBaiQH,$maKQHT,$dat_A,$dat_B,$dat_C,$dat_D,$chuadat,$maCanBo=1)
    {
        //cap nhat bang thongke_clo_hocphan
        $tk=thongke_clo_hocphan::where('maCTBaiQH',$maCTBaiQH)->where('maKQHT',$maKQHT)->where('maCanBo',$maCanBo)->first();
        if($tk){  //neu da co thong ke truoc do thi cap nhat lai
            $tk->dat_A=$dat_A;
            $tk->dat_B=$dat_B;
            $tk->dat_C=$dat_C;
            ...
            thongke_clo_hocphan::create(['maCTBaiQH'=>$maCTBaiQH,'maKQHT'=>$maKQHT,'maCanBo'=>$maCanBo,
                'dat_A'=>$dat_A,'dat_B'=>$dat_B,'dat_C'=>$dat_C,'dat_D'=>$dat_D,'chua_dat'=>$chuadat]);
        }
    }
