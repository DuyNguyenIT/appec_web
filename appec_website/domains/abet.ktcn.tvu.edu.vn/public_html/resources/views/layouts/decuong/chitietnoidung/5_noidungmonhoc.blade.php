                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="maKQHT[]" id="" class="form-control select2" style="width:100%" multiple required>
            ...
            <tr>
                <td>
                    ...
                    <div class="btn-group">
                        ...
                        <a title="Delete" class="btn btn-danger"
                            ...
                            href="{{ asset('/quan-ly/hoc-phan/de-cuong-mon-hoc/xoa-noi-dung-mon-hoc/'.$data->id) }}">
                    ...
                    <div class="modal fade" id="edit_chapter_{{ $data->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog" role="document">
                            <form action="{{ asset('/quan-ly/hoc-phan/de-cuong-mon-hoc/sua-noi-dung-mon-hoc') }}" method="post">
                                @csrf
                                <div class="modal-content">
                                    <div class="modal-header">
                    ...
                    <div class="modal fade" id="addMuc_{{ $data->id }}" tabindex="-1" role="dialog"
                        ...
                        <div class="modal-dialog" role="document">
                            <form action="{{ asset('/quan-ly/hoc-phan/de-cuong-mon-hoc/them_noi_dung_muc_chuong') }}"
                                method="POST">
                                @csrf
                                <div class="modal-content">
                                    <div class="modal-header">
                    ...
                    <div class="modal fade" id="addMucDoKyNangUIT_{{ $data->id }}" tabindex="-1" role="dialog"
                        aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog" role="document">
                            <form action="{{ asset('/quan-ly/hoc-phan/de-cuong-mon-hoc/them_muc_do_ky_nang_uti') }}"
                                method="POST">
                                @csrf
                                <div class="modal-content">
                                    <div class="modal-header">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="maCDR1" id="" class="form-control select2" style="width:100%">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="maKQHT[]" id="" class="form-control select2" style="width:100%" multiple>
                ...
                <td>
                    ...
                    @foreach ($data->chuong_kqht as $item)
                        ...
                        <a title="Delete" 
                            onclick="return confirm('Confirm?')"
                            href="{{ asset('/quan-ly/hoc-phan/de-cuong-mon-hoc/xoa-chuong-ket-qua-hoc-tap/'.$data->id.'/'.$item->maKQHT) }}">
                            <i class="fa fa-trash"></i>
                        </a>;
                    @endforeach
                    ...
                    <div class="modal fade" id="add_hpkqht_{{$data->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog" role="document">
                        <form action="{{ asset('/quan-ly/hoc-phan/de-cuong-mon-hoc/them-chuong-ket-qua-hoc-tap') }}" method="post">
                        @csrf
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalLabel">{{ __('Edit') }}</h5>
                ...
                <tr>
                    <td>
                        <div class="btn-group">
                            ...
                            <a title="Delete" class="btn btn-danger"
                                onclick="return confirm('Confirm?')"
                                href="{{ asset('/quan-ly/hoc-phan/de-cuong-mon-hoc/xoa_noi_dung_muc_chuong/'.$m->id) }}">
                                <i class="fa fa-trash"></i>
                            </a>
                        </div>
                        {{ $m->maMucVB }}
                    ...
                    <div class="modal fade" id="edit_muc_{{$m->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog" role="document">
                            <form action="{{ asset('/quan-ly/hoc-phan/de-cuong-mon-hoc/sua_noi_dung_muc_chuong') }}" method="post">
                            @csrf
                            <div class="modal-content">
                                <div class="modal-header">
                    ...
                    <td colspan="4">
                        @foreach ($mudokynangUIT as $uit)
                            @if ($uit->maCDR1 == $CDR1[$i]['maCDR1'] && $uit->id_chuong == $data->id)
                                ...
                                <a title="Delete" 
                                    onclick="return confirm('Confirm?')"
                                    href="{{ asset('/quan-ly/hoc-phan/de-cuong-mon-hoc/xoa_muc_do_ky_nang_uti/'.$uit->id) }}">
                                    <i class="fa fa-trash"></i>
                                </a>;
                            @endif
                        @endforeach
