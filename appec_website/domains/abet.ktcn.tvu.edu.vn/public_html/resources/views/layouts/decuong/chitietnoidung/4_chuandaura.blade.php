                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="maCDR3[]" id="" class="form-control select-item select2" style="width:100%" multiple >
                                                @foreach ($cdr as $t)
                        ...
                        <tr>
                            ...
                            <td rowspan={{ $rs }}>
                                ...
                                <div class="modal fade" id="add_cdio_{{ $x->maKQHT }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    <div class="modal-dialog" role="document">
                                        <form action="{{ asset('/quan-ly/hoc-phan/de-cuong-mon-hoc/them-ket-qua-hoc-tap-chuan-dau-ra') }}" method="post">
                                        @csrf
                                            <div class="modal-content">
                                                <div class="modal-header">
                            ...
                            <td>
                                <div class="btn-group">
                                    ...
                                    <a title="Delete" class="btn btn-danger"
                                        onclick="return confirm('Confirm?')"
                                        href="{{ asset('/quan-ly/hoc-phan/de-cuong-mon-hoc/xoa_chuan_dau_ra_mon_hoc/'.$x->id) }}">
