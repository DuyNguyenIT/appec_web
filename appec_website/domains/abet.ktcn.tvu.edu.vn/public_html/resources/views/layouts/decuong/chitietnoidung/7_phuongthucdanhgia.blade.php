    ...
    <tbody>
        ...
        @foreach ($hocPhan_loaiHTDG as $data)
            <tr>
                ...
                <td>
                    ...
                    <a title="Delete" class="btn btn-danger"
                        ...
                        href="{{ asset('/quan-ly/hoc-phan/de-cuong-mon-hoc/xoa_phuong_phap_danh_gia/'.$data->id) }}">
                ...
                <td>
                    ...
                    @if ($data->hp_loaihtdg_kqht)
                        @foreach ($data->hp_loaihtdg_kqht as $t)
                            ...
                            onclick="return confirm('Confirm?')"
                            href="{{ asset('/quan-ly/hoc-phan/de-cuong-mon-hoc/xoa_hocphan_loaihtdg_kqht/'.$t->id) }}">
                         <i class="fa fa-trash"></i>
                     </a>;
                        @endforeach
                    @endif
                    ...
                    <div class="modal fade" id="add_{{ $data->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog" role="document">
                        <form action="{{ asset('/quan-ly/hoc-phan/de-cuong-mon-hoc/them_hocphan_loaihtdg_kqht') }}" method="post">
                        @csrf
                            <div class="modal-content">
                                <div class="modal-header">
            ...
            <div class="modal fade" id="edit_{{ $data->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <form action="{{ asset('/quan-ly/hoc-phan/de-cuong-mon-hoc/sua_phuong_phap_danh_gia') }}" method="post">
                    @csrf
                    <div class="modal-content">
