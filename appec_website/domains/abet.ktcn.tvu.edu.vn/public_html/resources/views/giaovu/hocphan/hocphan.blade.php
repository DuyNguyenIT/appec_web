                                                    ...
                                                    @foreach ($giangday as $gd)
                                                        <tr role="row" class="odd">
                                                            ...
                                                            <td>
                                                                ...
                                                                href="{{ asset('/giao-vu/hoc-phan-giang-day/xoa-hoc-phan-giang-day-don/' . $gd->maHocPhan . '/' . $gd->maLop . '/' . $gd->maHK . '/' . $gd->namHoc.'/' . $gv->maGV)  }}"><i
                                                            ...
                                                            <td>
                                                                <div class="btn btn-group">
                                                                    ...
                                                                    href="{{ asset('/giao-vu/hoc-phan-giang-day/xoa-hoc-phan-giang-day/' . $gd->maHocPhan . '/' . $gd->maLop . '/' . $gd->maHK . '/' . $gd->namHoc)  }}"><i
                                                                        class="fa fa-trash"></i></a>
                                                                </div>
