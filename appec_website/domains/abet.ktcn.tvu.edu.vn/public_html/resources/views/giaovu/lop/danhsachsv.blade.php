                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <div class="card-tools">
                                    <a href="{{ asset('/giao-vu/quan-ly-lop') }}" class="btn btn-secondary"><i
                            ...
                            <div class="card-header">
                                ...
                                <a href="{{ asset('/giao-vu/quan-ly-lop/tai-file-mau') }}">{{ __('Template file excel') }}</a>
                                <!-- Modal -->
                                <div class="modal fade" id="importExcel" tabindex="-1" role="dialog"
                                    aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    <div class="modal-dialog" role="document">
                                        <form
                                            action="{{ asset('/giao-vu/quan-ly-lop/cap-nhat-ds-sinh-vien-bang-excel') }}"
