                ...
                <td colspan="3">
                    ...
                    <div class="modal fade" id="chuDe_{{ $cdr1->maCDR1VB }}" tabindex="-1" role="dialog"
                        ...
                        <div class="modal-dialog" role="document">
                            <form action="{{ asset('/giang-vien/phan-bien-de-cuong/them_chuan_dau_ra_mon_hoc') }}"
                                method="post">
                                @csrf
            ...
            @foreach ($kqht as $x)
                @if ($x->maCDR1 == $cdr1->maCDR1)
                        ...
                        <tr>
                            ...
                            <td rowspan={{ $rs }}>
                                <a title="Delete" class="btn btn-danger"
                                    ...
                                    href="{{ asset('/giang-vien/phan-bien-de-cuong/xoa-ket-qua-hoc-tap-mon-hoc/'.$x->maKQHT) }}">
                                ...
                                <div class="modal fade" id="add_cdio_{{ $x->maKQHT }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    <div class="modal-dialog" role="document">
                                        <form action="{{ asset('/giang-vien/phan-bien-de-cuong/them-ket-qua-hoc-tap-chuan-dau-ra') }}" method="post">
                                        @csrf
                                            <div class="modal-content">
                                                <div class="modal-header">
                            ...
                            <td>
                                <div class="btn-group">
                                    ...
                                    <a title="Delete" class="btn btn-danger"
                                        onclick="return confirm('Confirm?')"
                                        href="{{ asset('/giang-vien/phan-bien-de-cuong/xoa_chuan_dau_ra_mon_hoc/'.$x->id) }}">
                    ...
                    <div class="modal fade" id="editKQHT_HP_{{ $x->id }}" tabindex="-1" role="dialog"
                        aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <form action="{{ asset('/giang-vien/phan-bien-de-cuong/sua_chuan_dau_ra_mon_hoc') }}"
                            method="post">
                            @csrf
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
