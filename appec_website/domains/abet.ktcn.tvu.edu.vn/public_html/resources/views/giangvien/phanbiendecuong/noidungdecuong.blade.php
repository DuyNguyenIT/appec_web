                ...
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark">
                            Phản biện đề cương <noscript></noscript>
                            <nav></nav>
                        </h1>
                    </div>
                    <!-- /.col -->
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">Phản biện đề cương</li>
                        </ol>
                    </div>
                    <!-- /.col -->
                </div>
                            ...
                            <div class="card-header">
                                <div class="card-tools">
                                    <a class="btn btn-primary"
                                        href="{{ asset('/giang-vien/phan-bien-de-cuong/in-de-cuong-mon-hoc/'. $hocPhan->maHocPhan) }}"><i
                                            class="fas fa-download"></i></a>
                                    <a href="{{ asset('/giang-vien/phan-bien-de-cuong') }}" class="btn btn-secondary" onclick="clear_local()"><i
                            ...
                            <div class="card-body">
                                <div class="tab-content" id="custom-tabs-one-tabContent">
                                    <div class="tab-pane fade " id="P1" role="tabpanel" aria-labelledby="P1">
                                        @include('giangvien.phanbiendecuong.chitietnoidung.1_thongtinchung')
                                    </div>
                                    <div class="tab-pane fade " id="P2" role="tabpanel" aria-labelledby="P2">
                                        @include('giangvien.phanbiendecuong.chitietnoidung.2_tailieuthamkhao')
                                    </div>
                                    <div class="tab-pane fade " id="P3" role="tabpanel" aria-labelledby="P3">
                                        @include('giangvien.phanbiendecuong.chitietnoidung.3_motahocphan')
                                    </div>
                                    <div class="tab-pane fade " id="P4" role="tabpanel" aria-labelledby="P4">
                                        @include('giangvien.phanbiendecuong.chitietnoidung.4_chuandaura')
                                    </div>
                                    <div class="tab-pane fade " id="P5" role="tabpanel" aria-labelledby="P5">
                                        @include('giangvien.phanbiendecuong.chitietnoidung.5_noidungmonhoc')
                                    </div>
                                    <div class="tab-pane fade " id="P6" role="tabpanel" aria-labelledby="P6">
                                        @include('giangvien.phanbiendecuong.chitietnoidung.6_phuongphapgiangday')
                                    </div>
                                    <div class="tab-pane fade " id="P7" role="tabpanel" aria-labelledby="P7">
                                        @include('giangvien.phanbiendecuong.chitietnoidung.7_phuongthucdanhgia')
                                    </div>
                                    <div class="tab-pane fade " id="P8" role="tabpanel" aria-labelledby="P8">
                                        @include('giangvien.phanbiendecuong.chitietnoidung.8_cacquydinhchung')
                                    </div>
                                </div>
                            </div>
                            <!-- /.card-body -->
