  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Thống kê theo kết quả học tập<noscript></noscript><nav></nav></h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Thống kê theo kết quả học tập</li>
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                ...
                {{-- <a href="{{ asset('/quan-ly/thong-ke/thong-ke-theo-hocphan/export') }}">
                  <button class="btn btn-success"> 
                    <i class="fas fa-file-excel" aria-hidden="true"></i>xuất file excel
                  </button>
                </a> --}}
              </div>
              <!-- /.card-header -->
...
<script>
  $(function () {
     ...
     $.ajax({
         type:'GET',
         url:"{{ asset('/giang-vien/hoc-phan/thong-ke/thong-ke-theo-hocphan/get-kqht/'.$hocPhan->maHocPhan.'/'.$lop->maLop) }}",
