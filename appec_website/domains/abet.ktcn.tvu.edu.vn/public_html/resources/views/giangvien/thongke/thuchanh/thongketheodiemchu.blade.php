    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark">Thống kê theo điểm chữ<noscript></noscript>
                            <nav></nav>
                        </h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <div class="card-tools">
                                    <a href="{{ asset('/giang-vien/thong-ke/thong-ke-theo-hoc-phan/thuc-hanh/xuat-thong-ke-diem-chu/'.Session::get('maCTBaiQH')) }}" class="btn btn-success">
        ...
        <script>
            $(function() {
                ...
                $.ajax({
                    type: 'GET',
                    url: '/giang-vien/thong-ke/thong-ke-theo-hoc-phan/thuc-hanh/get-diem-chu',
