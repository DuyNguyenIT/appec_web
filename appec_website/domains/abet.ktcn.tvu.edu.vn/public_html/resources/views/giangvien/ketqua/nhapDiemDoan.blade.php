                                            ...
                                            @foreach ($tieuchi as $tc)
                                                ...
                                                @if ($chayTieuChuan == 1)
                                                    <tr>
                                                        ...
                                                        @endif
                                                        <td>
                                                            <select name="chamdiem1[]" id ="cd21{{$cdcheck}}">
                                                            @for($i=0; $i<=$tc->diemTCCD; $i=$i+0.25)                                                                 
                                                        ...
                                                        <script>
                                                            ...
                                                            document.getElementById('cd21{{$cdcheck}}').onclick= function(e)
                                                            {
                                                            
                                                               
                                                                if(document.getElementById('cd21{{$cdcheck}}').value==0)
                                                    ...
                                                    <td>
                                                        <input type="checkbox" name="chamdiem[]"
                                                            value="{{ $tc->maTCCD }}" id= "cd1{{$cdcheck}}" />
                                                            <script>                                                     
                                                                document.getElementById('cd1{{$cdcheck}}').onchange = function(e)
                                                                {
                                                                   
                                                                   if(document.getElementById('cd1{{$cdcheck}}').checked)
                                                                   document.getElementById('cd21{{$cdcheck}}').value= {{$tc->diemTCCD}};
                                                                   else
                                                                   document.getElementById('cd21{{$cdcheck}}').value= 0;
                                                ...
                                                @else
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input type="checkbox" name="chamdiem[]"
                                                                value="{{ $tc->maTCCD }}" id= "cd11{{$cdcheck}}"/>
                                                                <script>                                                     
