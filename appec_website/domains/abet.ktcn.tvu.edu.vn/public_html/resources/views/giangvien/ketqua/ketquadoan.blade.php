                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">
                                    <b>{{ __("Granding officer") }} 1:</b> {{ $gv->hoGV }} {{ $gv->tenGV }} {{$gv->LoaiCB}}<br />
                                    <b>{{ __("Granding officer") }} 2:</b> {{ $gv2->hoGV }} {{ $gv2->tenGV }} {{$gv2->LoaiCB}}<br />
                                </h4>
                                ...
                                <table id="example2" class="table table-bordered table-hover">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>{{ __('Student ID') }}</th>
                                            <th>{{ __('Mark of granding officer') }} 1</th>
                                                        ...
                                                        <td>
                                                            <a
                                                                ...
                                                                <button class="btn btn-success">
                                                                    <i class="fas fa-eye"></i> {{ __('Mark of granding officer') }} 1
                                                                </button>
                                                            </a>
                                                            <a
                                                                href="{{ asset('/giang-vien/ket-qua-danh-gia/xem-ket-qua-danh-gia/' . $dt->maDe . '/' . $dt->maSSV . '/2') }}">
                                                                <button class="btn btn-primary">
                                                                    <i class="fas fa-eye"></i> {{ __('Mark of granding officer') }} 2
                                                                </button>
                                                            </a>
                                                        </td>
                                                    @endif
