    ...
    <tr>
        ...
        <td><i>
                @foreach ($monTQ as $data)
                    ...
                    href="{{ asset('/giang-vien/bien-soan-de-cuong/xoa-mon-tien-quyet/'.$data->id) }}">
        ...
        <td>
            ...
            <div class="modal fade" id="addMonTQ" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                ...
                <div class="modal-dialog" role="document">
                    <form action="{{ asset('/giang-vien/bien-soan-de-cuong/them_mon_tien_quyet') }}"
                        method="post">
                        @csrf
        ...
        <td>
            ...
            <div class="modal fade" id="addyeuCau" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                ...
                <div class="modal-dialog modal-lg" role="document">
                    <form action="{{ asset('/giang-vien/bien-soan-de-cuong/sua_yeu_cau_mon_hoc') }}"
                        method="post">
                        @csrf
                        <div class="modal-content">
                            <div class="modal-header">
