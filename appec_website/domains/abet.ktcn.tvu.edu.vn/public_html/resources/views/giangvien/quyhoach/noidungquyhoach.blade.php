                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item"><a href="{{ asset('/giang-vien/quy-hoach-danh-gia/quy-hoach-ket-qua/'.Session::get('maHocPhan').'/'.Session::get('maBaiQH').'/'.Session::get('maHK').'/'.Session::get('namHoc').'/'.Session::get('maLop')) }}">{{ $lht->tenLoaiHTDG }}</a></li>

                            <li class="breadcrumb-item active">{{ __('Assessment planing content') }}</li>
                        </ol>
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
                                ...
                                <table id="example2" class="table table-bordered table-hover">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>{{ __('Level Assessment') }} (Bloom)</th>
                                            <th>{{ __('SOs') }}</th>
                                            <th>{{ __('Option') }}</th>
                                        </tr>
                                    </thead>
