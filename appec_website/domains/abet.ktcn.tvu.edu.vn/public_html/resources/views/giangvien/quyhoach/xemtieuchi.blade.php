                                                ...
                                                <tr>
                                                            ...
                                                            <div class="modal-dialog" role="document">
                                                                ...
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-body">
                                                                        ...
                                                                        <div class="form-group">
                                                                            <label for="">Tên tiêu chuẩn:</label> <span style="color: red">(*)</span>
                                                                            <input type="text" name="tenTCDG" value="{{  $tc->tenTCDG }}" required class="form-control">
                                                                        </div>
                                                                        <div class="form-group">
                                                                            <label for="">Điểm:</label> <span style="color: red">(*)</span>
                                                    ...
                                                    @if ($chayCDR_TCDG == 1)
                                                        <td rowspan={{ $demTC_CDR }}>{{ $tc->maCDR3VB }}:
                                                            {{ $tc->tenCDR3 }}; <br> {{ $tc->maChuanAbetVB }}-- {{ $tc->tenChuanAbet }}
                                                            ...
                                                            <div class="modal fade" id="sua_tieu_chi_{{ $tc->maTCCD }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                                <div class="modal-dialog" role="document">
                                                                    ...
                                                                    @csrf
                                                                        ...
                                                                        <div class="modal-content">
                                                                            <div class="modal-header">
                                                                                <h5 class="modal-title" id="exampleModalLabel">Sửa tiêu chí</h5>
                                                                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                                                    <span aria-hidden="true">&times;</span>
                                                                                </button>
                                                                            </div>
