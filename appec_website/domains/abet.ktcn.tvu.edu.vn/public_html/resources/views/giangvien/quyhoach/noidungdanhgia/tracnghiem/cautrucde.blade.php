                ...
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark">
                            {{ __("Exam structure") }} trắc nghiệm<noscript></noscript>
                            <nav></nav>
                        </h1>
                    </div>
                    <!-- /.col -->
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <input type="checkbox" name="check_all" >Chọn hết
                                <script>
                            ...
                            <div class="card-body">
                                ...
                                <form action="{{ asset('/giang-vien/quy-hoach-danh-gia/noi-dung-danh-gia/xem-noi-dung-danh-gia/xoa-nhieu-cau-hoi-trac-nghiem') }}" method="post">
                                    @csrf
                                    <button type="submit" class="btn btn-danger">  <i class="fas fa-trash"></i> Xóa nhiều câu hỏi</button>
                                    <br>
                                    @foreach ($noidung as $data)
                                        ...
                                        <b>Câu </b> {{ $index++ }} <b>({{ $data->diem }} điểm) </b>  <input type="checkbox" name="select_all[]" value="{{ $data->maCauHoi }}"> <br>
