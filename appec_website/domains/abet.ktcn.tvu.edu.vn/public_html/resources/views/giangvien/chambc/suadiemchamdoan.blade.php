    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark">Sửa phiếu đánh giá đồ án<noscript></noscript>
                            <nav></nav>
                        </h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                            ...
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <div class="card-tools">
                                        <a href="{{ asset('/giang-vien/cham-diem-bao-cao/nhap-ket-qua-danh-gia/'.session::get('maCTBaiQH')) }}" class="btn btn-success">
                                        ...
                                        @foreach ($tieuchi as $tc)
                                            ...
                                            @if ($chayTieuChuan == 1)
                                                <tr>
                                                    ...
                                                    <td>  @if($tc->diemDG>0)
                                                         <input id= "cd1{{$cdcheck}}" type="checkbox" name="chamdiem[]" value="{{ $tc->maTCCD }}"   checked  />điểm
                                                         @else
                                                            <input id= "cd1{{$cdcheck}}" type="checkbox" name="chamdiem[]" value="{{ $tc->maTCCD }}"/>điểm
                                                         @endif
                                                       </td>
                                                        <script>                                                     
                                                    ...
                                                    <td>
                                                        <select name="chamdiem1[]" id ="cd2{{$cdcheck}}" >
                                                            ...
                                                            <script>                                                     
                                                                ...
                                                                <td> @if($tc->diemDG>0) 
                                                                        <input id= "cd11{{$cdcheck}}" type="checkbox" name="chamdiem[]" value="{{ $tc->maTCCD }}"  checked />điểm
                                                                       @else
                                                                       <input id= "cd11{{$cdcheck}}" type="checkbox" name="chamdiem[]" value="{{ $tc->maTCCD }}"/>điểm
                                                                       @endif
                                                                       <script>                                                            
