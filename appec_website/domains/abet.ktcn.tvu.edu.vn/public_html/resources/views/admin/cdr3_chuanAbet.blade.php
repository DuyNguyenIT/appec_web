                ...
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark">
                            {{ __('Level-3 Student Outcomes') }} <-> Abet <noscript></noscript>
                                <nav></nav>
                        </h1>
                    </div>
                    <!-- /.col -->
                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog"
                                    ...
                                    <div class="modal-dialog modal-lg" role="document">
                                        <form action="{{ asset('quan-ly/chuan-dau-ra3-abet/them') }}" method="post">
                                            @csrf
                            ...
                            <div class="card-body">
                                <table class="table table-bordered fixed_header">
                                    <thead>
                                        <tr>
                                            <th>{{ __('Level-3 Student Outcomes') }}</th>
                                            @foreach ($chuanAbet as $abet)
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($cdr3 as $cd3)
                                            <tr>
                                                <td>
                                                    @if (Session::has('language') && Session::get('language') == 'vi')
                                                        {{ $cd3->maCDR3VB }}--{{ $cd3->tenCDR3 }}
                                                    @else
                                                        {{ $cd3->maCDR3VB }}--{{ $cd3->tenCDR3EN }}
                                                    @endif
                                                </td>
                                                @foreach ($chuanAbet as $abet)
                                                    <td>
                                                        @foreach ($cdr3_abet as $data)
                                                            @if ($data->maChuanAbet == $abet->maChuanAbet && $data->maCDR3 == $cd3->maCDR3)
                                                                ...
                                                                <div class="modal fade" id="edit_{{ $data->id }}"
                                                                    ...
                                                                    <div class="modal-dialog" role="document">
                                                                        <form
                                                                            action="{{ asset('/quan-ly/chuan-dau-ra3-abet/sua') }}"
                                                                            method="post">
                                                                            @csrf
                                                                            <div class="modal-content">
                                                                                <div class="modal-header">
                                                                                ...
                                                                                <div class="modal-footer">
                                                                                    ...
                                                                                    @if (Session::has('language') && Session::get('language') == 'vi')
                                                                                        <a href="{{ asset('/quan-ly/chuan-dau-ra3-abet/xoa/' . $data->id) }}"
