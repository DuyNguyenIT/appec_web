                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item"><a
                                    href="{{ asset('quan-ly/hoc-phan') }}">{{ __('Courses') }}</a></li>
                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="card-title">
                                    {{ __('Course name') }}: {{ $hp->tenHocPhan }}--{{ __('Course ID') }}:
                                    {{ $hp->maHocPhan }}
                                </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a title="Delete" class="btn btn-danger"
                                                        ...
                                                        href="{{ asset('quan-ly/hoc-phan/xoa-hoc-phan-ct-dao-tao/' . $data->id) }}"><i
                                                            class="fa fa-trash"></i></a>
                                                    <!-- Modal -->
                                                    <div class="modal fade" id="edit_{{ $data->id }}" tabindex="-1"
                                                        role="dialog" aria-labelledby="exampleModalLabel"
                                                        aria-hidden="true">
                                                        <div class="modal-dialog" role="document">
                                                            <form
                                                                action="{{ asset('/quan-ly/hoc-phan/chinh-sua-hoc-phan-ct-dao-tao') }}"
                                                                method="post">
                                                                @csrf
