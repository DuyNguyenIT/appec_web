                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select name="maCTKhoiKT" id="" class="form-control select2" style="width:100%" required>
                                                            @foreach ($ctkhoi as $x)
                                                                <option value="{{ $x->maCTKhoiKT }}">
                                                                    {{ $x->maCTKhoiKT }}
                                                                    - {{ $x->tenCTKhoiKT }}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="">{{ __('Curriculum') }}</label>
                                                        <select name="maCT" id="" class="form-control select2" style="width:100%" required>
                                                            @foreach ($ctdt as $y)
                                                                <option value="{{ $y->maCT }}"> {{ $y->tenCT }}
                                                                </option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" min="1" max="8" name="phanPhoiHocKy"
                                                            class="form-control" required>
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="">{{ __('Course Type') }}</label>
                                                        <select name="maLoaiHocPhan" id="" class="form-control select2" style="width:100%" required>
                                                            @foreach ($loaihp as $z)
                                                                <option value="{{ $z->maLoaiHocPhan }}">
