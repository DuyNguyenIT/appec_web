                              ...
                              <div class="card-header">
                                  ...
                                  <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog"
                                      ...
                                      <div class="modal-dialog" role="document">
                                          <form action="/quan-ly/bac-dao-tao/them" method="post"
                                              enctype="multipart/form-data">
                                              @csrf
                                              <div class="modal-content">
                                                  <div class="modal-header">
                                                      <h5 class="modal-title" id="exampleModalLabel">
                                                          {{ __('Adding a new') }} {{ __('education level') }}</h5>
                                              ...
                                              <tr>
                                                  ...
                                                  <td>
                                                      <button title="Edit" type="button" class="btn btn-primary"
                                                          data-toggle="modal" data-target="#edit_{{ $item->maBac }}">
                                                          <i class="fas fa-edit"></i>
                                                      </button>
                                                      <!-- Modal edit-->
                                                      <div class="modal fade" id="edit_{{ $item->maBac }}" tabindex="-1"
                                                              ...
                                                              <form action="{{ asset('quan-ly/bac-dao-tao/sua') }}"
                                                                  ...
                                                                  <div class="modal-content">
                                                                      ...
                                                                      <div class="modal-body">
                                                                          ...
                                                                          <div class="form-group">
                                                                              <label
                                                                                  for="">{{ __('Education level Name') }}</label>
                                                                              <input type="text" name="tenBac"
                                                                                  class="form-control"
                                                                                  value="{{ $item->tenBac }}" required>
                                                                          </div>
                                                                      </div>
                                                                      <div class="modal-footer">
                                                                          <button type="submit"
                                                      ...
                                                      <a title="Delete" class="btn btn-danger"
                                                          onclick="return confirm('Do you want to delete {{ $item->tenBac }}?')"
                                                          href="{{ asset('quan-ly/bac-dao-tao/xoa/' . $item->maBac) }}"><i
                                                              class="fa fa-trash"></i>
                                                      </a>
                                                  </td>
                                              </tr>
