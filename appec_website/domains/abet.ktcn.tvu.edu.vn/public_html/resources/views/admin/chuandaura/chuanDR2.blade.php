                        ...
                        @csrf
                          <div class="modal-content">
                            <div class="modal-header">
                              <h5 class="modal-title" id="exampleModalLabel">Adding a new Level-2 Student Outcome</h5>
                            ...
                            <div class="modal-body">
                              <div class="form-group">
                                ...
                                <label for="">Level-2 Student Outcome ID (number)</label>
                                <input type="text" name="maCDR2VB" class="form-control" placeholder="">
                              </div>
                                <div class="form-group">
                                  <label for="">Level-2 Student Outcome Name (Vietnamese)</label>
                                  <input type="text" name="tenCDR2" class="form-control" placeholder="">
                                </div>
                                <div class="form-group">
                                  <label for="">Level-2 Student Outcome Name (English)</label>
              ...
              <div class="card-body">
                <table id="example2" class="table table-bordered table-hover">
                  <thead>
                    <tr>
                      <th>No.</th>
                      <th>Level-2 Student Outcome ID</th>
                      <th>Level-2 Student Outcome Name (Vietnamese)</th>
                      <th>Level-2 Student Outcome Name (English)</th>
                      <th>Level-1 Student Outcome</th>
                              ...
                              <div class="modal-content">
                                <div class="modal-header">
                                  <h5 class="modal-title" id="exampleModalLabel">
                                    Editing Level-2 Student Outcome Information
                                  </h5>
                                  <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">×</span>
                                  </button>
