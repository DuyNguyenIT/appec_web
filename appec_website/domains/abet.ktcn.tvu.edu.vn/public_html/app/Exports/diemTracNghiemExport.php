...
class diemTracNghiemExport implements FromView
{
    public function view(): View
    {
        ...
        return view('giangvien.ketqua.tracnghiem.exportViewTracNghiem.exportDiemTracNghiem',compact('hp','dssv','deThi','phieucham'));
    }
}
