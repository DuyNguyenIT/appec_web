...
class cauHoi extends Model
{
    ...
    {
        return self::where('isDelete',false)->where('maGV',session::get('maGV'))->where('maCauHoi',$maCauHoi)->first();
    }
    public static function get_cau_hoi_trac_nghiem($maHocPhan) //lay tat ca cau hoi trac nghiem trong hoc phan
    {
        ...
        return self::where('isDelete',false)->where('maGV',session::get('maGV'))->where('maLoaiHTDG','T2')->whereIn('id_muc',$muc)->get();
    }

    public static function get_cau_hoi_trac_nghiem_by_mamuc($maMuc) //lay cau hoi trac nghiem theo muc
    {
        return self::where('isDelete',false)->where('maGV',session::get('maGV'))->where('id_muc',$maMuc)->where('maLoaiHTDG','T2')->get();
    }
    ...
    public static function get_cau_hoi_trac_nghiem_by_mamuc_distinct($maDe,$maMuc) //lay cau hoi trac nghiem khong co trong de thi
    {
        ...
        return self::where('isDelete',false)->where('maGV',session::get('maGV'))->where('id_muc',$maMuc)->whereNotIn('maCauHoi',$dt_arr)->where('maLoaiHTDG','T2')->get();
    }
    ...
    public static function get_cau_hoi_tu_luan_by_mamuc_distinct($maDe,$maMuc) //ham xu ly get cau hoi tu luan (tru nhung cau hoi trong de thi)
    {
        ...
        return self::where('isDelete',false)->where('maGV',session::get('maGV'))->where('id_muc',$maMuc)->where('maLoaiHTDG','T1')->whereNotIn('maCauHoi',$dt_arr)->get();
    }
    ...
    public static function get_cau_hoi_tu_luan($maHocPhan)  //lay tat ca cau hoi tu luan trong hoc phans
    {
        $chuong=chuong::where('maHocPhan',$maHocPhan)->pluck('id');
        $muc=muc::whereIn('id_chuong',$chuong)->get('id');
        return self::where('isDelete',false)->where('maGV',session::get('maGV'))->where('maLoaiHTDG','T1')->whereIn('id_muc',$muc)->get();
    }
    //xu ly cho thuc hanh
    ...
    {
        $dt_arr=dethi_cauhoituluan::where('maDe',$maDe)->pluck('maCauHoi');
        return self::where('isDelete',false)->where('maGV',session::get('maGV'))->where('id_muc',$maMuc)->where('maLoaiHTDG','T3')->whereNotIn('maCauHoi',$dt_arr)->get();
    }
    ...
    public static function get_cau_hoi_thuc_hanh($maHocPhan)  //lay tat ca cau hoi thuc hanh trong hoc phan
    {
        $chuong=chuong::where('maHocPhan',$maHocPhan)->pluck('id');
        $muc=muc::whereIn('id_chuong',$chuong)->get('id');
        return self::where('isDelete',false)->where('maGV',session::get('maGV'))->where('maLoaiHTDG','T3')->whereIn('id_muc',$muc)->get();
    }
