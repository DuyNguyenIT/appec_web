...
class muc extends Model
{
    ...
    public static function get_all_by_maHocPhan($maHocPhan)
    {
        $chuong_arr=chuong::where('maHocPhan',$maHocPhan)->pluck('id');
        return self::whereIn('id_chuong',$chuong_arr)->orderBy('maMucVB')->get();
    }
